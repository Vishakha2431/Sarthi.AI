        ...
        <div className='relative min-h-screen bg-[#050505] text-white overflow-hidden'>
            ...
            <div className='sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center'>
                    <div className='flex items-center gap-4'>
                        ...
                        <h1 className='text-lg font-semibold'>Sarthi.AI</h1>
                    </div>
                </div>
            </div>
            <div className='max-w-6xl mx-auto px-6 py-16 relative z-10'>
                ...
                >
                    ...
                    <p className='text-zinc-400 max-w-2xl mx-auto'>This process may take several minutes. Sarthi.AI focuses on quality not shortcuts</p>
                ...
                <div className='mb-10'>
                    ...
                    <div className='relative'>
                        ...
                        className='w-full h-56 p-6 rounded-3xl bg-black/60 border border-white/10 outline-none resize-none text-sm leading-relaxed focus:ring-2 focus:ring-white/20' placeholder='Describe Your Website in detail...' />
                    </div>
                ...
                <div className='flex justify-center'>
                    <motion.button
                        ...
                        className={`px-14 py-4 rounded-2xl font-semibold text-lg transition ${prompt.trim() && !loading ? "bg-white text-black": "bg-white/20 text-zinc-400 cursor-not-allowed"}`}>
                        Generate Website
                    </motion.button>
                </div>
                {
