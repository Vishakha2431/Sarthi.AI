...
const Home = () => {
    ...
    const startBuilding = () => {
        console.log("clicked")
        if (!user) {
            // show an explicit popup and open login modal
            try { window.alert('Please sign up or log in before building a website.') } catch (e) {}
            setOpenLogin(true)
            return
        }
        navigate('/dashboard')
            ...
            <section className='relative min-h-screen bg-[#050505] text-white overflow-hidden'>
                ...
                <div className='relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center'>
                    ...
                    <motion.h1
                        ...
                        <span className='bg-linear-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent'>AI in Seconds</span>
                    </motion.h1>
                    ...
                    >
                        <button onClick={startBuilding} className='flex items-center justify-center gap-2 px-6 py-3 bg-indigo-500 hover:bg-indigo-600 rounded-xl font-semibold transition'>
                            Start Building <ArrowRight size={18} />
                        </button>
                        <button className='px-6 py-3 border border-white/20 hover:bg-white/10 rounded-xl transition'>Watch Demo</button>
                    </motion.div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-20'>
                        ...
                        <div className='p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition'>
                            ...
                            <p className='text-sm text-gray-400'>Websites look perfect on mobile,tablet and desktop</p>
                        </div>
                        <div className='p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition'>
