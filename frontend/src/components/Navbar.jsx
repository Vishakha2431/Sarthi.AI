            ...
            >
                <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-2 cursor-pointer bg-white/5 p-2 px-4 rounded-2xl border border-zinc-600'>
                        <img src="ai2.png" alt="" />
                        <span className='font-semibold text-lg bg-linear-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent'>Sarthi.AI</span>
                    </div>
                    {/* right side */}
                            ...
                            <div className='relative'>
                                <button
                                    ...
                                    <img referrerPolicy='no-referrer'
                                        src={userData ? userData.avatar : "https://ui-avatars.com/api/?name=Vishakha+Gautam"} alt="" className='w-9 h-9 rounded-full border border-white/20 object-cover hover:scale-105 transition' />
                                </button>
                                <AnimatePresence>
                                    {openProfile && (
                                        <motion.div
